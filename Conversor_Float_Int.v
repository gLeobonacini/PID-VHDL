...
// ============================================================
// File Name: Conversor_Float_Int.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clock dataa result
...
module  Conversor_Float_Int_altbarrel_shift_kof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //Conversor_Float_Int_altbarrel_shift_kof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Conversor_Float_Int_altfp_convert_98n
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	Conversor_Float_Int_altbarrel_shift_kof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //Conversor_Float_Int_altfp_convert_98n
//VALID FILE
...
module Conversor_Float_Int (
	...
	Conversor_Float_Int_altfp_convert_98n	Conversor_Float_Int_altfp_convert_98n_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Conversor_Float_Int.cmp TRUE TRUE
